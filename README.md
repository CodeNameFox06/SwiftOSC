...
Embed SwiftOSC into the project.
...
### OSC Client
#### Step 1
Import SwiftOSC fram# SwiftOSC v1.4
...
### OSC Client
#### Step 1
Import SwiftOSC frework into your project
```swift
import SwiftOSC
```
#### Step 2
...
Send bundle
```swift
// If the server fully supports time tags, like SwiftOSC, the bundle will be delivered at the correct time.
client.send(bundle)
```
